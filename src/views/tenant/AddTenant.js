...
const AddTenant = () => {
      ...
      const fetchTenantData = async () => {
        ...
        try {
          ...
          if (tenant) {
            ...
            setIdProofFiles(tenant.idProof || []);
          }
        } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //Append tenant data to form data.
      formData.append('tenantName', tenantData.tenantName);
      formData.append('contactInformation[email]', tenantData.contactInformation.email);
      formData.append('contactInformation[phoneNumber]', tenantData.contactInformation.phoneNumber);
      formData.append('contactInformation[emergencyContact]', tenantData.contactInformation.emergencyContact);
